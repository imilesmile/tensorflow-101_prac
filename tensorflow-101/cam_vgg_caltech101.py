...
path = "/Users/miao/Documents/tensorflow/101_ObjectCategories"
...
VGG_PATH = "/Users/miao/Documents/tensorflow/imagenet-vgg-verydeep-19.mat"
...
with tf.device(device_type):
    ...
    def cam(_x, _W, _b, _kr):
        ...
        gap = tf.nn.avg_pool(conv_dr, ksize=[1, 14, 14, 1], strides=[1, 14, 14, 1], padding='SAME')
...
# define function for the network
with tf.device(device_type):

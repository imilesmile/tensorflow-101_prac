...
def attention(inputs, attention_size, time_major=False, return_alphas=False):
    ...
    :param inputs: the attention inputs
                matches outputs of RNN/Bi-RNN layer (not final state)
                    ...
                    if time_major=False this must be a tensor of shape
                        `[batch_size, max_time, cell, output_size]`
                    if time_major=True his must be a tensor of shape
    ...
    :param return_alphas: whether to return attention coefficients variable along with layer's output.
            used for visualizzation purpose
    :return:
        the attention output 'tensor'.
        in case of rnn, this will be a tensor shape:
        [batch_size, cell,output_size]
        incase of bi-rnn, this will be a tensor shape:
